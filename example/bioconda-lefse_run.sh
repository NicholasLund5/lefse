...
python ../lefse/lefse_plot_res.py hmp_aerobiosis_small.res hmp_aerobiosis_small.png
...
python ../lefse/lefse_plot_features.py hmp_aerobiosis_small.in hmp_aerobiosis_small.res biomarkers_raw_images/
